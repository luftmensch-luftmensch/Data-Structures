...
g++ -O3 -o main \
  ...
  zmytest/BinarySearchTree/BinarySearchTreeInt.cpp \
  zmytest/BinarySearchTree/BinarySearchTreeFloat.cpp \
  zmytest/BinarySearchTree/BinarySearchTreeString.cpp \
  zmytest/BinarySearchTree/OperazioniDaEseguire.cpp \
  main.cpp
